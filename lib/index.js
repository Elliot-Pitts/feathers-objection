...
var commitTransaction = async function commitTransaction(trxOptions, knex) {
  ...
  var result = await _objection2.default.transaction(knex, async function (trx) {
    ...
    value: async function create(data, params) {
      ...
      try {
        if (params.trx) {
          ...
          return await _objection2.default.transaction(this.Model.knex(), async function (trx) {
